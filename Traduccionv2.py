...
class TraductorDeDirecciones:
    ...
    def _inicializar_tabla_paginas(self, mapas_iniciales):
        """Inicializa la tabla de páginas con los mapeos del archivo."""
    ...
    def traducir(self, direccion_virtual):
        ...
        print("\n--- Resultado ---")
        print(f"Dirección Virtual: {direccion_virtual} -> 🎯 Dirección Física: {direccion_fisica}")
        print("-----------------")
...
if __name__ == "__main__":
    try:
        ...
        print("\n--- Listo para traducir ---")
        while True:
            dv_str = input("Ingrese una dirección virtual ('q' para salir): ")
            if dv_str.lower() == 'q':
                break
